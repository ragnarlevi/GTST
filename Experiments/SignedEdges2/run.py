...
parser.add_argument('-p1', '--p1', type=float,metavar='', help='probability of sign 1 in sample 1')
parser.add_argument('-p2', '--p2', type=float,metavar='', help='probability of sign 1 in sample 2')
...
if __name__ == "__main__":
    ...
    bg1 = mg.ScaleFreeGraph(n1, nnode1, exponent = 2.5, fullyConnected = True, e = 'edge_random_sign', p_sign = p1, e_name='sign', l = 'edges')
    bg2 = mg.ScaleFreeGraph(n2, nnode2, exponent = 2.5, fullyConnected = True, e = 'edge_random_sign', p_sign = p2, e_name='sign', l = 'edges')
