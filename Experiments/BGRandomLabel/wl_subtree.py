...
parser.add_argument('-pmf','--pmf', type = float, nargs='+',metavar='', help='Probability mass distribution for label distribution for sample 2')
...
if __name__ == "__main__":
    ...
    bg1 = mg.BinomialGraphs(n1, nnode1, k1, l = 'rnglabels', pmf = None, nr_letters = len(pmf2) )
    bg2 = mg.BinomialGraphs(n2, nnode2, k2, l = 'rnglabels' ,pmf = pmf2, nr_letters = len(pmf2) )
