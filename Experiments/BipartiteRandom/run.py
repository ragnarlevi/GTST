...
parser.add_argument('-p1', '--p1', type=float,metavar='', help=' edge probability 1')
parser.add_argument('-p2', '--p2', type=float,metavar='', help='edge probability 1')
parser.add_argument('-n_set_1', '--n_set_1', type=int,metavar='', help=' Number of nodes in set 1 in sample 1')
parser.add_argument('-n_set_2', '--n_set_2', type=int,metavar='', help='Number of nodes in set 1 in sample 2')
...
if __name__ == "__main__":
    ...
    p1 = args.p1
    p2 = args.p2
    nnode_set_1_1 = args.n_set_1
    nnode_set_1_2 = args.n_set_2
    ...
    bg1 = mg.bipartiteRandom(n = n1, nnode = nnode1, p= p1, nnode_set_1= nnode_set_1_1, l = 'degreelabels', fullyConnected =  True) 
    bg2 = mg.bipartiteRandom(n = n2, nnode = nnode2, p= p2, nnode_set_1= nnode_set_1_2, l = 'degreelabels', fullyConnected =  True) 
    ...
    for alpha in alphas:
        ...
        tmp = pd.DataFrame({'kernel': str(kernel), 
                        ...
                        'p_edge_1': p1,
                        'p_edge_2': p2,
                        'degree_1': p1*float(nnode1-1) ,
                        'degree_2': p2*float(nnode2-1),
                        'nnode_set_1_1':nnode_set_1_1,
                        'nnode_set_1_2':nnode_set_1_2,
                        'n':n1,
                        'm':n2,
                        'timestap':time,
                        'B':B,
