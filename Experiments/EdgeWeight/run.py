...
parser.add_argument('-u1l', '--u1l', type=float,metavar='', help='lower bound uniform 1')
parser.add_argument('-u1u', '--u1u', type=float,metavar='', help='upper bound uniform 1')
parser.add_argument('-u2l', '--u2l', type=float,metavar='', help='lower bound uniform 2')
parser.add_argument('-u2u', '--u2u', type=float,metavar='', help='upper bound uniform 2')
...
if __name__ == "__main__":
    ...
    bg1 = mg.ScaleFreeGraph(n1, nnode1, k1, fullyConnected = True, e = 'random_edge_weights', ul = u1l, uu =u1u)
    bg2 = mg.ScaleFreeGraph(n2, nnode2, k2, fullyConnected = True, e = 'random_edge_weights',  ul = u1l, uu =u1u)
