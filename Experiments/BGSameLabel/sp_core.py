...
parser.add_argument('-mc', '--minCore', type=int,metavar='', help='Minimum core number')
...
if __name__ == "__main__":
    ...
    kernel = [{"name": "core_framework", "min_core": min_core}, {"name": "SP", "with_labels": True}]
