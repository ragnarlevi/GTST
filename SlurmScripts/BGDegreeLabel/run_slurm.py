...
Path(f"data/BGDegreeLabel/{k_val}").mkdir(parents=True, exist_ok=True)
Path(f"/home/{usr}/projects/MMDGraph/SlurmBatch/BGDegreeLabel/{k_val}").mkdir(parents=True, exist_ok=True)
