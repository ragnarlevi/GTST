...
for nr_node in nr_nodes:
    for nr_sample in nr_samples:
        for k_off in degree_offsets:
            ...
            f"#SBATCH --output=/home/{usr}/projects/MMDGraph/outputs/wwl_v_{nr_node}_n_{nr_sample}_k_{k_off}_wl_{n_itr}_discount_{discount}_sink_{sinkhorn}_norm_{norm}.out",
            f"#SBATCH --error=/home/{usr}/projects/MMDGraph/errors/wwl_v_{nr_node}_n_{nr_sample}_k_{k_off}_wl_{n_itr}_discount_{discount}_sink_{sinkhorn}_norm_{norm}.err",
